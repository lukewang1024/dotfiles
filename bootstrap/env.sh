...
util_setup()
{
  ...
  backup_then_symlink "$util_dir/agent/code-ship" "$bin_dir/code-ship"
  ...
  backup_then_symlink "$util_dir/agent/open-computer-use-sync" "$bin_dir/open-computer-use-sync"
  ...
  "$util_dir/agent/open-computer-use-sync" || true
